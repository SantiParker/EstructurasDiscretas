...
-- Convierte una lista de pares (carácter, frecuencia)
-- en hojas individuales del árbol Huffman.
...
-- Inserta un árbol dentro de una lista manteniendo
-- el orden ascendente según su peso.
-- Esto permite combinar siempre primero los nodos
-- menos frecuentes durante la construcción Huffman.
